...
<main role="main" class="container">
  <div class="jumbotron">
    ...
    <p class="lead">You can send a message to "admin" user from this form!<br/>
    Please note. The "admin" user access this page with "http://web11/message.php", not ip-address!</p>
